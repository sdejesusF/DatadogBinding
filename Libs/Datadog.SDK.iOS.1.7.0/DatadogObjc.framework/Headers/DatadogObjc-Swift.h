...
- (void)enableCrashReportingUsing:(id <DDCrashReportingPluginType> _Nonnull)crashReportingPlugin;
...
- (void)trackUIKitActions SWIFT_DEPRECATED_MSG("This option is replaced by `trackUIKitRUMActions(using:)`. Refer to the new API comment for details.");
- (void)trackUIKitRUMActions;
- (void)trackUIKitRUMActionsUsing:(id <DDUIKitRUMUserActionsPredicate> _Nonnull)predicate;
- (void)setRUMViewEventMapper:(DDRUMViewEvent * _Nonnull (^ _Nonnull)(DDRUMViewEvent * _Nonnull))mapper;
...
+ (DDEndpoint * _Nonnull)us1 SWIFT_WARN_UNUSED_RESULT;
+ (DDEndpoint * _Nonnull)us3 SWIFT_WARN_UNUSED_RESULT;
+ (DDEndpoint * _Nonnull)eu1 SWIFT_WARN_UNUSED_RESULT;
+ (DDEndpoint * _Nonnull)us1_fed SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSString *> * _Nonnull tracePropagationHTTPHeaders;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
+ (DDLogsEndpoint * _Nonnull)us1 SWIFT_WARN_UNUSED_RESULT;
+ (DDLogsEndpoint * _Nonnull)us3 SWIFT_WARN_UNUSED_RESULT;
+ (DDLogsEndpoint * _Nonnull)eu1 SWIFT_WARN_UNUSED_RESULT;
+ (DDLogsEndpoint * _Nonnull)us1_fed SWIFT_WARN_UNUSED_RESULT;
...
@interface DDNSURLSessionDelegate : NSObject <__URLSessionDelegateProviding, NSURLSessionDataDelegate>
...
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id> * _Nonnull contextInfo;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id> * _Nonnull usrInfo;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
+ (DDTracesEndpoint * _Nonnull)us1 SWIFT_WARN_UNUSED_RESULT;
+ (DDTracesEndpoint * _Nonnull)us3 SWIFT_WARN_UNUSED_RESULT;
+ (DDTracesEndpoint * _Nonnull)eu1 SWIFT_WARN_UNUSED_RESULT;
+ (DDTracesEndpoint * _Nonnull)us1_fed SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP11DatadogObjc30DDUIKitRUMUserActionsPredicate_")
@protocol DDUIKitRUMUserActionsPredicate
